 ...
 * @author 8741417
 */
public class p_interv_nivers extends javax.swing.JPanel {

    /** Creates new form p_prox_nivers */
    public p_interv_nivers(String s) {
        initComponents();
        carregarNomes(s);
    }
...
//                p[ri][1] += "/2009";
    ...
    private void jTProximosMouseClicked(java.awt.event.MouseEvent evt) {
